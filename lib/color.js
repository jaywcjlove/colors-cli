...
Colors.prototype.valueOf = function(){
    ...
    //     }
    //     if (this.fgcolor_bt !== null) {
    //       text = '\x1b[38;5;' + this.fgcolor_bt + 'm' + text + reset;
    //     }
    //     if (this.bgcolor_bbt !== null) {
    //         console.log(this.bgcolor_bbt)
    //       text = '\x1b[48;5;' + this.bgcolor_bbt + 'm' + text + reset;
    //     }
    // }else{
    // }
